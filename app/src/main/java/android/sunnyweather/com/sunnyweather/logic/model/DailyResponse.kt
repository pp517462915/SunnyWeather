...
data class DailyResponse(val status: String, val result:Result){
    data class Result(val daily: Daliy)

    data class Daliy(val temperature: List<Temperature>, val skycon: List<SkyCon>, @SerializedName("life_index") val lifeIndex: LifeIndex)
